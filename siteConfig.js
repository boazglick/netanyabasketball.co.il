module.exports = {
  siteUrl: "https://netanyabasketball.co.il", // Site domain. Do not include a trailing slash!

  postsPerPage: 12, // Number of posts shown on paginated pages (changes this requires sometimes to delete the cache)

  siteTitleMeta: "netanyabasketball.co.il", // This allows an alternative site title for meta data for pages.
  siteDescriptionMeta:
    "netanyabasketball.co.il", // This allows an alternative site description for meta data for pages.

  shareImageWidth: 1000, // Change to the width of your default share image
  shareImageHeight: 523, // Change to the height of your default share image

  shortTitle: "netanyabasketball.co.il", // Used for App manifest e.g. Mobile Home Screen
  ...
  header: {
    navigation: [
      {
        label: "דף הבית",
        url: "https://netanyabasketball.co.il/",
      },
      {
        label: "יצירת קשר",
        url: "https://netanyabasketball.co.il/contact",
      },
    ],
  },
  footer: {
    ...
    navigation: [
      ...
      {
        label: "Sitemap",
        url: "https://netanyabasketball.co.il/sitemap.xml",
      },
  ...
  siteTitle: "netanyabasketball.co.il",
  siteDescription:
    "netanyabasketball.co.il",
  language: "he",
  logoUrl: "logo.png",
